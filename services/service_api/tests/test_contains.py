...
_VALID_CABINET_NUMBERS = [('11', '11'), ('12к', '12К'), ('31', '31'), ('315', '315'), ('42к', '42К'), ('52к', '52К'),
                          ('сз3', 'СЗ3'), ('упм1л6', 'упм. 1, л. 6')]
...
_GROUP_LESSON_VALUES = [
    (datetime.time(9, 0), datetime.time(9, 45), 'Математика', (random.choice(_CABINET_ITEMS),)),
    (datetime.time(9, 55), datetime.time(10, 40), 'Биология', (random.choice(_CABINET_ITEMS),)),
    (datetime.time(10, 50), datetime.time(11, 35), 'Физкультура', (random.choice(_CABINET_ITEMS),)),
    (datetime.time(11, 45), datetime.time(12, 40), 'Рус. лит.', (random.choice(_CABINET_ITEMS),)),
